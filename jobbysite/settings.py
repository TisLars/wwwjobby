# Django settings for jobbysite project.
import os
...
DATABASES = {
    'default': {
        ...
        'USER': 'Project',
        'PASSWORD': 'Wachtwoord4MYSQL',
        'HOST': '',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
        'PORT': '8007',                      # Set to empty string for default.
    }
}
...
SECRET_KEY = 'rgj*o1atcn%--cs2h*2c3@7_f$*6#hfsch@))+na^yk6y%a99!'
...
ROOT_URLCONF = 'jobbysite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'jobbysite.wsgi.application'
